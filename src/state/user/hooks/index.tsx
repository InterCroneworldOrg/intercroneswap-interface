import { ChainId, Pair, Token, FACTORY_ADDRESS_MAP, INIT_CODE_HASH_MAP } from '@intercroneswap/v2-sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Iswap LP', 'Iswap LP Token')
}
