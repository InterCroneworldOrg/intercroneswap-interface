import { ChainId, JSBI, Percent, Token } from '@intercroneswap/v2-sdk'
...
export const ACTUAL_LAUCH_TOKEN: Token = mainnetTokens.pman
export const LAUNCH_START_TIME: Date = new Date(1682712000000)
