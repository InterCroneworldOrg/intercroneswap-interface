...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@intercroneswap/swap-sdk';
  ...
  */
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe(
        '0x404A895237C97B75d4Cf96C8Ad9760687692613A',
      );
      expect(isAddress('0x404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe(
        '0x404A895237C97B75d4Cf96C8Ad9760687692613A',
      );
