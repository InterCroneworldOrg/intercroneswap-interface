...
export const USDJ = new Token(ChainId.MAINNET, '0x834295921A488D9D42B4B3021ED1A3C39FB0F03E', 18, 'USDJ ', 'JUST Stablecoin',);
...
export const EightEightEight = new Token(ChainId.MAINNET, '0x7818637395075A1AAA82927801DAB4117B99FC3F', 6, '888 ', '888Tron',);
export const SafeMoney = new Token(ChainId.MAINNET, '0x8605CAE8C40545D2184D59550918185F44D9EA0D', 8, 'SafeMoney ', 'SafeMoney',);
export const JM = new Token(ChainId.MAINNET, '0xd3d54671fca80648a5886f990fd40117f94d247f', 8, 'JM ', 'J U S T M O N E Y',);
...
export const COME = new Token(ChainId.MAINNET, '0xea98a5047a37dd4b10f331adb17b55aafa682f19', 18, 'COME', 'CommunityEarth',);
