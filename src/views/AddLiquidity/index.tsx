...
import { Button, Text, AddIcon, CardBody, Message, useModal, useMatchBreakpoints, Flex } from '@pancakeswap/uikit'
...
export default function AddLiquidity() {
  ...
  async function onAdd() {
    ...
    if (currencyA === ETHER || currencyB === ETHER) {
      ...
      estimate = routerContract.estimateGas.addLiquidityTRX
      method = routerContract.addLiquidityTRX
      args = [
