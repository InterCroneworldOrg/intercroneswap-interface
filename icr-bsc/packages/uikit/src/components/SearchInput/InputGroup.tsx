...
import { SearchInputGroupProps, scales, Scales } from "./types";
...
const InputGroup = ({ scale = scales.MD, startIcon, endIcon, children, ...props }: SearchInputGroupProps): JSX.Element => (
  <StyledInputGroup
    scale={scale}
    width="100%"
    position="relative"
